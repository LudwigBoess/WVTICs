...
OPT     += -DSPH_WC4               #wendland c4 kernel
#OPT     += -DSPH_WC6               #wendland c6 kernel
#OPT     += -DSPH_WC8               #wendland c8 kernel
#OPT     += -DSPH_WC10               #wendland c10 kernel
#OPT     += -DSPH_WC12               #wendland c12 kernel
